...
/**
 * This class was written by Rob Camick 2009 and updated 2019 by me Elias Renman to not use deprecated functions.
 *  @see <a href="tips4java">https://tips4java.wordpress.com/2009/05/23/text-component-line-number/</a>
 * This class will display line numbers for a related text component. The text
 * component must use the same line height for each line. com.sqlcom.utilities.TextLineNumber
...
public class TextLineNumber extends JPanel
     ...
     * <ul>
     * <li>com.sqlcom.utilities.TextLineNumber.LEFT
     * <li>com.sqlcom.utilities.TextLineNumber.CENTER
     * <li>com.sqlcom.utilities.TextLineNumber.RIGHT (default)
     * </ul>
     *
    ...
    public void paintComponent(Graphics g) {
        ...
        while (rowStartOffset <= endOffset) {
            try {
                ...
                double y = getOffsetY(rowStartOffset, fontMetrics);
                g.drawString(lineNumber, x, (int) y);
     ...
     */
    private double getOffsetY(int rowStartOffset, FontMetrics fontMetrics)
